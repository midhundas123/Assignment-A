package com.axelerant.utilities;
...
public class PageUtility {
    ...
    public WebDriver selectByVisibleText(WebDriver driver, WebElement element, String text) {
        Select objSelect =new Select(element);
        objSelect.selectByVisibleText(text);
        return (driver);
    }

    public WebDriver clickWithJS(WebDriver driver, WebElement element) {
